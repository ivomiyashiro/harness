...
2. Write `docs/state/epic-$ARGUMENTS.md` (format §7): one line per sub-spec with dependency, status, and branch. No detailed design at epic level — design happens inside each sub-spec's own pipeline.
