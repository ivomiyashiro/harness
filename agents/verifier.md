...
- Bash is limited to `node scripts/harness-observe.js <registered-profile> [safe operands]`; filesystem/Git mutation, redirection, pipelines, options, and arbitrary commands are denied.
